      ...
      collapseItems: [
        {
          ...
          content: [
            ...
            },
            {
              id: 2,
              text:
                'Prof characteristics: responsibility, communication skills, quick-learning, punctuality, good analytical skills, creative.',
            },
            {
              id: 3,
              text:
                'Hobbies: reading, travelling, sports, enjoy life with friends, movies, gaining new skills in development.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              id: 1,
              text:
                'LPNU/Bachelor of Science/Food technology - sept 2015 - may 2019',
            },
            {
              id: 2,
              text:
